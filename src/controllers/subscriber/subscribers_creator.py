...
class EventsCreator:  # Corrigido "classs" para "class"
    def __init__(self, subs_repo: SubscribersRepositoryInterface):
        self.__subs_repo = subs_repo  # Corrigido "events_repo" para "subs_repo"
    ...
    def __insert_sub(self, subscriber_info: dict) -> None:
        self.__subs_repo.insert(subscriber_info)  # Removida a chamada recursiva
    ...
    def __format_response(self, subscriber_info: dict) -> HttpResponse:
        return HttpResponse(
            ...
            status_code=201  # Corrigido a posição de status_code
        )
